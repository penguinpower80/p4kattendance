...
urlpatterns = [
          ...
          path('ajax/list/schools', views.schoollist, name='schoollist'),
          path('ajax/list/classrooms/<str:school_id>', views.classroomlist, name='classroomlist'),
          path('ajax/list/students/<int:classroom_id>', views.studentlist, name='studentlist'),

...
class ll_ATS(unittest.TestCase):
    ...
    def test_ll(self):
        ...
        time.sleep(1)
        driver.find_element_by_xpath(" /html/body/section[1]/div/div/form/div[1]/div/div/div[1]/input ").send_keys("ngummadi@unomaha.edu")
        time.sleep(1)
        driver.find_element_by_xpath(" /html/body/section[1]/div/div/form/div[1]/div/div/div[2]/button/span[2]").click()
        time.sleep(1)

        try:
            elem = driver.find_element_by_xpath("/html/body/header/div/div/div[2]/nav/div[2]/div/div[1]/a")
            text = elem.text
            time.sleep(2)
            assert text == "Home"

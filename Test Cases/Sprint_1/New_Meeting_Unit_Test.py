...
class ll_ATS(unittest.TestCase):
    ...
    def test_ll(self):
        ...
        time.sleep(3)
        driver.find_element_by_xpath("//*[@id=\"classroom-1\"]/div/div/ul/li/a").click()

        try:
            elem = driver.find_element_by_xpath('//*[@id=\"maincontent\"]/div/div/div[2]/h3')
            text = elem.text
            # attempt to find the 'Logout' button - if found, logged in

            time.sleep(2)
            assert text == "Jeremiah Stafford"

...
def _generateNotesReport(entity, entity_id, start_date, end_date, show_all):
    if entity == 'school':
    ...
    report = render_to_string('reports/notes.html',{
        'student': student,
        'school': school,
        'classroom': classroom,
        'notes': notes,
...
def _generateStudentReport(entity, entity_id):
...
def sendNotesReport(sender, to, entity, entity_id, start_date, end_date, show_all=True, ):
    ...
    report = _generateNotesReport(entity, entity_id, start_date, end_date, show_all)
...
def sendStudentsReport(sender, to, entity, entity_id):
    ...
    message = "Please find attached a {} report of student assignments from the Partnership 4 Kids system.  " \
              "This report was generated by {} on {}".format(entity, sender, datetime.now())
    report = _generateStudentReport(entity, entity_id)
